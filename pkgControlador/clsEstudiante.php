...
include_once '../pkgModelo/conexion.php';
...
class Estudiante extends Conexion {
    ...
    public function buscar() {
        $resultado = pg_query($this->acceder_conexion(), "SELECT 1 as res,nombre,apellido,cedula,edad,semestre from estudiante where codigo='" . $this->codigo . "'") or die("Problemas en la consulta: " . pg_last_error());
    ...
    public function listar() {
        $resultado = pg_query($this->acceder_conexion(), "SELECT 1 as res,codigo,nombre,apellido,cedula,edad,semestre from estudiante") or die("Problemas en la consulta: " . pg_last_error());
        $this->listadoRegistro($resultado);
    }
}
?>
